...
HD_PWD='/home/asus/Documents/ara-build-playground/ARA-SOC_viv/ARA-SOC_viv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_ara_soc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xilinx_ara_soc.tcl -notrace
