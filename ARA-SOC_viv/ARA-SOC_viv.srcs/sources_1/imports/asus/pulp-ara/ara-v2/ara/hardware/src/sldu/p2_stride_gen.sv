...
module p2_stride_gen import ara_pkg::*; import rvv_pkg::*; import cf_math_pkg::idx_width; #(
  ...
  `FFL(             popc_q,              popc_d, ff_en, '0, clk_i, rst_ni);
  `FFL(next_stride_first_q, next_stride_first_d, ff_en, '0, clk_i, rst_ni);
  `FFL( next_stride_zero_q,  next_stride_zero_d, ff_en, '0, clk_i, rst_ni);
  `FFL(     spare_stride_q,      spare_stride_d, ff_en, '0, clk_i, rst_ni);
