...
module fpnew_divsqrt_th_32 #(
  ...
  `FFL(fdsu_fpu_ex1_stall_q, fdsu_fpu_ex1_stall, 1'b1, '0, clk_i, rst_ni)
  `FFL(div_op_q, div_op_d, 1'b1, '0, clk_i, rst_ni)
  `FFL(sqrt_op_q, sqrt_op_d, 1'b1, '0, clk_i, rst_ni)
  ...
  `FFL(result_mask_q, inp_pipe_mask_q[NUM_INP_REGS], op_starting, '0, clk_i, rst_ni)
  ...
  `FFL(unit_ready_q, unit_ready_d, 1'b1, 1'b1, clk_i, rst_ni)
  ...
  `FF(ex2_inst_wb_vld_q, ex2_inst_wb_vld_d, '0, clk_i, rst_ni)
