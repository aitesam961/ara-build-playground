...
module ara_dispatcher import ara_pkg::*; import rvv_pkg::*; #(
  ...
  `FF(csr_vstart_q, csr_vstart_d, '0, clk_i, rst_ni)
  `FF(csr_vl_q, csr_vl_d, '0 ,clk_i, rst_ni)
  `FF(csr_vtype_q, csr_vtype_d, '{vill: 1'b1, default: '0},  clk_i, rst_ni)
  `FF(csr_vxsat_q, csr_vxsat_d, '0, clk_i, rst_ni)
  `FF(csr_vxrm_q, csr_vxrm_d, '0, clk_i, rst_ni)
  ...
  `FF(load_complete_q, load_complete_i || illegal_insn_load, 1'b0, clk_i, rst_ni)
  `FF(store_complete_q, store_complete_i || illegal_insn_store, 1'b0, clk_i, rst_ni)
              ...
              OPIVX: begin: opivx
                ...
                unique case (insn.varith_type.func6)
                  ...
                  6'b001110: begin
                    ...
                    if (|ara_req_d.stride[$bits(ara_req_d.stride)-1:$bits(csr_vl_q)]) null_vslideup = 1'b1;
                  end
                  6'b001111: begin
                    ara_req_d.op            = ara_pkg::VSLIDEDOWN;
                    ara_req_d.stride        = acc_req_i.rs1;
