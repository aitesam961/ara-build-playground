...
HD_PWD='/home/asus/Documents/ara-build-playground/CVA6_VPF/CVA6_VPF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ariane.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ariane.tcl
