...
HD_PWD='/home/asus/Documents/ara-build-playground/ara-salone/ara-salone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ara.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ara.tcl
