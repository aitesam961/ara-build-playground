...
HD_PWD='/home/asus/Documents/ara-build-playground/cva6-stalone/cva6-stalone.runs/ila_bootrom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_bootrom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_bootrom.tcl
